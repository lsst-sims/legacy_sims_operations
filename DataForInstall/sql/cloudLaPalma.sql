...
DROP TABLE IF EXISTS CloudLaPalma;

CREATE TABLE CloudLaPalma (
...
CREATE UNIQUE INDEX c_date_cloud_idx ON CloudLaPalma (c_date,cloud);


GRANT SELECT, UPDATE, DELETE, INSERT on CloudLaPalma to www;
