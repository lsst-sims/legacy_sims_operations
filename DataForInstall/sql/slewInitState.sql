...
DROP TABLE IF EXISTS SlewInitState;


# SlewInitState
CREATE TABLE SlewInitState (
  slewIniStatID	bigint AUTO_INCREMENT PRIMARY KEY,
...
CREATE INDEX sis_sessID_slewCount_idx ON SlewInitState (sessionID, slewCount);

# Grant privileges to the www user
GRANT SELECT, UPDATE, DELETE, INSERT on SlewInitState to www;
