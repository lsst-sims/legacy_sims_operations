...
DROP TABLE IF EXISTS CloudTololoSD;

CREATE TABLE CloudTololoSD (
...
CREATE UNIQUE INDEX c_date_cloud_idx ON CloudTololoSD (c_date,cloud);


GRANT SELECT, UPDATE, DELETE, INSERT on CloudTololoSD to www;
