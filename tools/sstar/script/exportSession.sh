...
$mysql -u www -pzxcvbnm -e "select obsHistID, sessionID, propID, fieldID, fieldRA, fieldDec, filter, expDate, expMJD, night, visitTime, visitExpTime, finRank, finSeeing, transparency, airmass, vSkyBright, filtSkyBright as filtSkyBrightness, rotSkyPos, lst, altitude, azimuth, dist2Moon, solarElong, moonRA, moonDec, moonAlt, moonAZ, moonPhase, sunAlt, sunAz, phaseAngle, rScatter, mieScatter, moonIllum, moonBright, darkBright, rawSeeing, wind, humidity, slewDist, slewTime, fivesigma as fiveSigmaDepth, hexdithra as ditheredRA, hexdithDec as ditheredDec from $1.output_$2_$3" > Summary_$2_$3.dat

# Gzipping
tar zcvf $2_$3_datexport.tar.gz Cloud.dat Seeing.dat Field.dat *_$2_$3.dat

# mysqldump
$mysqldump -u www -pzxcvbnm $1 tConfig_File_$2_$3 tLog_$2_$3 tTimeHistory_$2_$3 Cloud Seeing tConfig_$2_$3 tSession_$2_$3 tProposal_Field_$2_$3 Field tMissedHistory_$2_$3 tProposal_$2_$3 tSeqHistory_$2_$3 tSeqHistory_MissedHistory_$2_$3 tSeqHistory_ObsHistory_$2_$3 tObsHistory_$2_$3 tObsHistory_Proposal_$2_$3 tSlewHistory_$2_$3 tSlewState_$2_$3 tSlewActivities_$2_$3 tSlewMaxSpeeds_$2_$3 output_$2_$3 > $2_$3_export.sql
