...
class Distribution(LSSTObject):
    ...
    def __init__(self, date, duration, log=False, logfile='./Distribution.log', verbose=-1):
        ...
        # The total number of events to distribute. It depends on the particular subclass and on its
        # duration in time.
...
class LinearDistribution(Distribution):
    ...
    def __init__(self, date, duration, interval, log=False, logfile='./Distribution.log', verbose=-1):
        ...
        super(LinearDistribution, self).__init__(date, duration, self.log, self.logfile, verbose)
        self.numAtomic = 1
        return
...
class LogDistribution(Distribution):
    ...
    def __init__(self, date, duration, interval, log=False, logfile='./Distribution.log', verbose=-1):
        ...
        # Run the superclass init
        super(LogDistribution, self).__init__(date, duration, log, logfile, verbose)
        self.numAtomic = 1
        return
...
class IvezicDistribution(Distribution):
    ...
    def __init__(self, date=0, duration=0.0, intervals=[], repeats=1, repeatdelay=0.0, log=False,
                 logfile='./Distribution.log', verbose=-1):
        """
        Standard initializer.
        ...
        super(IvezicDistribution, self).__init__(date, duration, self.log, self.logfile, verbose)
...
if __name__ == '__main__':
    ...
    class KnownValues (unittest.TestCase):
        ...
        def testLinearNextEvent(self):
            d = LinearDistribution(date=0, duration=self.duration, interval=self.linearInterval)
        ...
        def testIvezicNextEvent(self):
            d = IvezicDistribution(date=0, duration=self.duration)
