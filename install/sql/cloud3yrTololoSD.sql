...
DROP TABLE IF EXISTS Cloud3yrTololoSD;

CREATE TABLE Cloud3yrTololoSD (
...
CREATE UNIQUE INDEX c_date_cloud_idx ON Cloud3yrTololoSD (c_date,cloud);


GRANT SELECT, UPDATE, DELETE, INSERT on Cloud3yrTololoSD to www;
