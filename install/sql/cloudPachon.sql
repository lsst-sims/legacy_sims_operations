...
DROP TABLE IF EXISTS CloudPachon;

CREATE TABLE CloudPachon (
...
CREATE UNIQUE INDEX c_date_cloud_idx ON CloudPachon (c_date,cloud);


GRANT SELECT, UPDATE, DELETE, INSERT on CloudPachon to www;
